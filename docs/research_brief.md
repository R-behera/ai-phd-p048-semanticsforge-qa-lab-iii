...
SemanticsForge QA Lab: NLP for III-Aligned Research

## Motivation

This project targets the intersection of **NLP, ML, fairness, structured prediction** and PhD-level research readiness. The goal is to produce a publishable-style artifact with a clear claim, reproducible experiments, and an honest account of failures.
...
2. Add one measurable method or evaluation contribution tied to Hal Daume III's research area.
...
Advisor-specific slice: **NLP, ML, fairness, structured prediction**.
